jQuery(function($){
    ...
    $('.layout-btns .layout-full').click(function(e){
        ...
        if($(this).hasClass('active')){
            ...
            $('#house-block').removeClass('col-md-12 col-sm-12 full-content').addClass('col-sm-11 col-md-10');
            icon.removeClass('fa-compress').addClass('fa-expand');
            $(window).trigger('resize');
        } else {
            // full screen
            $('#left-side, ul.breadcrumb').hide('fast', function(){
                $('#house-block').removeClass('col-sm-11 col-md-10').addClass('col-md-12 col-sm-12 full-content');
