...
+function ($) { "use strict";
  ...
  , template: '<div class="popover editpop editable"><div class="arrow"></div><h3 class="popover-title"></h3><div class="popover-house"></div></div>'
  })
  ...
  Editpop.prototype.setContent = function () {
    ...
    $tip.find('.popover-house').html(this.content)

    var $form = $tip.find('.popover-house > form')
    $form.exform()
    ...
    $tip.find('.popover-house').prepend(this.$mask)
