(function($) {
  ...
  $(function(){
    var top_nav = $('#top-nav');
    $('#body-house').css('margin-top', (top_nav.height() + 15) + 'px');
    ...
    if($("#g-theme-menu")){
      $('#g-theme-menu li>a').click(function(){
        ...
        var modal = $('<div id="load-theme-modal" class="modal fade" role="dialog"><div class="modal-dialog"><div class="modal-house"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button><h4>'+
          ...
          $.save_user_settings("site-theme", themeHref, function(){
            ...
            $(iframe).load(function () {
              ...
              setTimeout(function(){
                ...
                $('#body-house').animate({'margin-top': (nav_height + 15)}, 500, 'easeOutBounce');
              }, 500);
