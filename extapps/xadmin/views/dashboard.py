...
class HtmlWidget(BaseWidget):
    ...
    description = _(u"Html Content Widget, can write any html house in widget.")
    ...
    def context(self, context):
        context["house"] = self.cleaned_data["content"]
    ...
    def __init__(
        ...
        **kwargs
        ...
        forms.Field.__init__(
            self, required, widget, label, initial, help_text, *args, **kwargs
        )
