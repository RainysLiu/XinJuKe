...
class House(models.Model):
    ...
    community = models.CharField(verbose_name='小区', max_length=20,blank=True,null=True,)
    ...
    image = models.ImageField(verbose_name='房屋主图片', blank=True,  null=True,upload_to='houseimg')  # 相对于MEDIA_ROOT目录
    ...
    add_time = models.DateTimeField(auto_now_add=True, verbose_name='添加时间', blank=True, null=True)
    house_detail = UEditorField(verbose_name='房屋详情',
                        blank=True, default='',
...
class Collections(models.Model):
    user = models.ForeignKey(MyUser,verbose_name='用户',blank=True,related_name='user_house')
    house = models.ForeignKey(House,verbose_name='收藏的房屋',blank=True,related_name='house_user')
    add_time = models.DateTimeField(auto_now_add=True, verbose_name='收藏时间', blank=True, null=True)
