    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cn', order.models.OrderNumberField(blank=True, max_length=20, null=True, verbose_name='订单号')),
                ('add_time', models.DateTimeField(auto_now_add=True, null=True, verbose_name='添加时间')),
                ('odify_time', models.DateTimeField(auto_now=True, null=True, verbose_name='更新时间')),
                ...
                ('status', models.CharField(choices=[('0', '待支付'), ('1', '已支付'), ('2', '待评价'), ('3', '已拒单'), ('4', '已取消')], max_length=20)),
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='user.MyUser', verbose_name='用户')),
            ],
            options={
                'verbose_name': '订单信息',
